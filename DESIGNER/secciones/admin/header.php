    ...
    <div class="navbar-collapse collapse" id="collapsingNavbar">
        <ul class="navbar-nav mr-auto">
          ...
          <div class="titulo-usuario">      
                <h4 class="text-center">BLOG DE REGISTRO DE TAREAS</h4>
          </div>
...
<!--                     <p><?php echo $_SESSION['usuario'] ?></p>
 -->                        <strong id="u-nombre"></strong>
                ...
                <li>
                    <i class="fas fa-file-alt"></i>
                    <a href="semana8.php">Semana 8</a>
                </li>
                <li>
                    <i class="fas fa-file-alt"></i>
                    <a href="semana9.php">Semana 9</a>
                </li>
                <li>
                    <i class="fas fa-file-alt"></i>
                    <a href="semana10.php">Semana 10</a>
                </li>
                <li>
                    <i class="fas fa-file-alt"></i>
                    <a href="semana11.php">Semana 11</a>
                </li>
                <li>
                    <i class="fas fa-file-alt"></i>
                    <a href="semana12.php">Semana 12</a>
                </li>
                <li>
                    <i class="fas fa-file-alt"></i>
                    <a href="semana13.php">Semana 13</a>
                </li>
            </ul>
        </div>
        <!--/col-->
