        ...
        <div class="container">
          ...
          <table class="table table-bordered" style="border-width: #32CD32">
            <tbody>
              <tr>
                <td rowspan="3" style="background-color: #2F4F4F">
                  <img src="../utilidades/facebook.png">
                </td>
                <td style="background-color: #00CED1"><b>Descripcion De La Tarea</b></td>
              </tr>

              <tr>
                <td rowspan="3"> se redactara los cokponesntes, descripcion sobre la red social de Facebook y admeas de sus principales fucncionalidades del mismo...
                  <br>
                  <a class="enlace" target="_blank" href="https://www.canva.com/design/DADpI5cBI04/IJM2bcKT3DQGPamc-U0PUQ/view?utm_content=DADpI5cBI04&utm_campaign=designshare&utm_medium=link&utm_source=sharebutton"> ir a mi tarea</a>
                  <br>
                  </td>
